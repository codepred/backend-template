...
import com.codepred.cleanrepo.account.AccountCredentialsRepository;
import com.codepred.cleanrepo.account.value_object.EncodedPassword;
import com.codepred.cleanrepo.account.value_object.Locked;
import com.codepred.cleanrepo.account.value_object.UserEmail;
import com.codepred.cleanrepo.account.value_object.UserRole;
import com.codepred.cleanrepo.auth.exception.InvalidPasswordForGivenEmailException;
import com.codepred.cleanrepo.auth.exception.LockedAccountException;
import com.codepred.cleanrepo.auth.query.LoginQuery;
...
class LoginQueryHandlerComponentBehaviourTest {
    ...
    void handleLoginQueryWithValidCredentials() {
        ...
        assertThat(response.getJwt().jwt()).isNotBlank();
    }
